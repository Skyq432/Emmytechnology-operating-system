...
type Settings = { company_default_margin_percent: number; company_archive_email: string | null; quotation_valid_days: number };
type MarginPolicy = { id: string; policy_scope: string; category: string | null; inventory_item_id: string | null; minimum_margin_percent: number; inventory_item?: { name?: string; sku?: string; category?: string | null } | null };
type Authority = { user_id: string; authority_level: string; discount_limit_percent: number; is_active: boolean };
type User = { id: string; name: string | null; email: string | null; role: string | null };
type InventoryItem = { id: string; sku: string; name: string; category: string | null };

export function SettingsWorkspace({ settings, marginPolicies, authorityProfiles, users, inventory }: { settings: Settings; marginPolicies: MarginPolicy[]; authorityProfiles: Authority[]; users: User[]; inventory: InventoryItem[] }) {
