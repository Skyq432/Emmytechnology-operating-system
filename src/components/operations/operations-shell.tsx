            ...
            {OPERATIONS_NAV.map((item) => {
              ...
              return (
                <div key={item.href} className="flex items-center gap-1">
                  <Link href={item.href} className={`flex min-w-0 flex-1 items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-semibold transition ${active ? 'bg-blue-50 text-[#032489]' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'}`}>
