...
export default function AdminOverview() {
  ...
  const statCards = [
    {
      ...
      icon: Users,
      color: 'bg-blue-500',
      href: '/modules/marketing/ambassadors',
    },
    {
      label: 'Review Items',
      ...
      href: stats.pendingLeadEdits > 0 || stats.unreadNotifications > 0 ? '/modules/marketing/leads' : '/modules/marketing/activities',
    },
    {
      label: 'Leads',
    ...
    },
    {
      ...
      icon: TrendingUp,
      color: 'bg-violet-500',
      href: '/modules/marketing/conversions',
    },
  ];
  ...
  return (
    <div className="space-y-8">
      ...
      {reviewItems > 0 && (
        <Link href={stats.pendingLeadEdits > 0 || stats.unreadNotifications > 0 ? '/modules/marketing/leads' : '/modules/marketing/activities'}>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <Card className="border border-slate-200 shadow-sm lg:col-span-2">
          <CardContent className="p-6">
            <div className="mb-6 flex items-center justify-between">
              ...
              <Link href="/modules/marketing/activities">
                <Button
                  variant="ghost"
                  size="sm"
        ...
        <Card className="border border-slate-200 shadow-sm">
          <CardContent className="p-6">
            ...
            <Link href="/modules/marketing/leaderboard">
              <Button
                variant="outline"
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <Link href="/modules/marketing/ambassadors">
        ...
        <Link href="/modules/marketing/leads">
          <Card className="cursor-pointer border border-slate-200 p-6 shadow-sm transition-all hover:border-slate-300 hover:shadow-md">
            <div className="flex items-center gap-4">
