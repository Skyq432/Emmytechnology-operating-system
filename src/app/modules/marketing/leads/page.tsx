    ...
    try {
      ...
      setLeads(
        (leadData || []).map((lead: any) => ({
          ...
          needs_merge_review: Boolean(lead.needs_merge_review),
        }))
      );
                    ...
                    <div className="flex min-w-0 items-start gap-3">
                      ...
                      <div className="min-w-0">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {lead.lead_type === 'ambassador_submission' && (
                            <Badge variant="info">Ambassador submission</Badge>
                          )}
          ...
          <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="rounded-2xl border border-slate-200 bg-white p-4">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                ...
                <MiniInfo
                  ...
                  value={
                    lead.lead_type === 'ambassador_submission'
                      ? 'Ambassador manual submission'
                      : lead.lead_type === 'admin_created'
                        ? 'Admin entry — approved immediately'
                        : lead.lead_type || lead.source
                  }
                />
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
              ...
              <div className="mt-4 grid gap-2">
                <Link
                  href={`/modules/marketing/leads/${lead.id}`}
