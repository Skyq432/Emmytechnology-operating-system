  ...
  async function fetchActivities() {
    try {
      ...
      const eventItems: ActivityItem[] = (leadEventsResponse.data || []).map((event: any) => {
        ...
        return {
          ...
          amount:
            ...
            null,
          href: event.lead_id ? `/modules/marketing/leads?lead=${event.lead_id}` : '/modules/marketing/leads',
      ...
      const notificationItems: ActivityItem[] = (notificationsResponse.data || []).map((notification: any) => ({
        ...
        href: notification.lead_id ? `/modules/marketing/leads?lead=${notification.lead_id}` : '/modules/marketing/leads',
      ...
      const bonusItems: ActivityItem[] = (bonusesResponse.data || []).map((bonus: any) => ({
        ...
        amount: bonus.amount,
        href: `/modules/marketing/ambassadors/${bonus.ambassador_id}`,
      ...
      const payoutItems: ActivityItem[] = (payoutsResponse.data || []).map((payout: any) => ({
        ...
        href: `/modules/marketing/ambassadors/${payout.ambassador_id}`,
