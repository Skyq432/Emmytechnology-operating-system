  ...
  return (
    <div className="mx-auto max-w-[1350px]">
      ...
      {order.commercial_state === 'draft' && <section className="mb-5 rounded-xl border border-blue-200 bg-blue-50/60 p-5">
        <div className="flex items-start gap-2"><div><h2 className="font-black text-[#032489]">Review before confirmation</h2><p className="mt-1 text-sm text-slate-600">Check customer, sales details, Ambassador, commission, price and fulfilment source. Confirmation triggers CRM, stock and commission actions.</p></div><HelpTip text="Draft is preparation only. Confirm when the sale is real." label="About confirming" /></div>
