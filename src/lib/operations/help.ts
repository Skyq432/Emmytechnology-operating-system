...
export const OPERATIONS_HELP: Record<string, string> = {
  ...
  totalRepairs: 'Repair jobs received in the selected period, excluding cancelled jobs.',
  collectedRepairs: 'Repairs the customer has already picked up.',
  uncollectedRepairs: 'Repairs still somewhere in the pipeline — not collected and not cancelled.',
