...
const salesPage = readFileSync(path.join(root, 'src/app/(staff)/modules/sales/page.tsx'), 'utf8');
const operationsPage = readFileSync(path.join(root, 'src/app/(staff)/modules/operations/page.tsx'), 'utf8');
